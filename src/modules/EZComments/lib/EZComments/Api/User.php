...
class EZComments_Api_User extends Zikula_AbstractApi
{
    ...
    public function getall($args = array())
    {
        ...
        if ($admin and !SecurityUtil::checkPermission('EZComments::','::', ACCESS_ADMIN)) { // this allows administrators to see all comments, including with empty modname column or orphaned
            // get list of modules
