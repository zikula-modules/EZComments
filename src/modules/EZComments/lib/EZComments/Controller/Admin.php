...
class EZComments_Controller_Admin extends Zikula_Controller
{
    ...
    public function main()
    {
        ...
        // Return the output
        return $renderer->fetch('ezcomments_admin_view.tpl');
    }
    ...
    public function modifyconfig()
    {
        ...
        return $zform->pnFormExecute('ezcomments_admin_modifyconfig.tpl', new EZComments_Form_Handler_Admin_ModifyConfig());
    }
    ...
    public function migrate()
    {
        ...
        // Return the output that has been generated by this function
        return $renderer->fetch('ezcomments_admin_migrate.tpl');
    }
    ...
    public function cleanup()
    {
        ...
        return $renderer->fetch('ezcomments_admin_cleanup.tpl');
    }
    ...
    public function purge($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $renderer->fetch('ezcomments_admin_purge.tpl');
        }
    ...
    public function stats()
    {
        ...
        // Return the output
        return $renderer->fetch('ezcomments_admin_stats.tpl');
    }
    ...
    public function modulestats()
    {
        ...
        // Return the output
        return $renderer->fetch('ezcomments_admin_modulestats.tpl');
    }
    ...
    public function deletemodule($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $renderer->fetch('ezcomments_admin_deletemodule.tpl');
        }
    ...
    public function deleteitem($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $renderer->fetch('ezcomments_admin_deleteitem.tpl');
        }
    ...
    public function applyrules($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $renderer->fetch('ezcomments_admin_applyrules_form.tpl');
        }
        ...
        if (!empty($confirmation) && $confirmation == 1) {
            ...
            // Return the output that has been generated by this function
            return $renderer->fetch('ezcomments_admin_applyrules_results.tpl');
        }
