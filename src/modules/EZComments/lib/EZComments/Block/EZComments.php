...
class EZComments_Block_EZComments extends Zikula_Controller_Block
{
    ...
    public function display($blockinfo)
    {
        ...
        $blockinfo['content'] = $renderer->fetch('ezcomments_block_ezcomments.tpl');
    ...
    public function modify($blockinfo)
    {
        ...
        return $renderer->fetch('ezcomments_block_ezcomments_modify.tpl');
    }
    ...
    public function update($blockinfo)
    {
        ...
        $renderer = Zikula_View::getInstance('EZComments');
        $renderer->clear_cache('ezcomments_block_ezcomments.tpl');
