...
class EZComments_Block_MostComments extends Zikula_Controller_Block
{
    ...
    public function display($blockinfo)
    {
        ...
        $blockinfo['content'] = $renderer->fetch('ezcomments_block_mostcomments.tpl');
    ...
    public function modify($blockinfo)
    {
        ...
        return $renderer->fetch('ezcomments_block_mostcomments_modify.tpl');
    } 
    ...
    public function update($blockinfo)
    {
        ...
        $renderer = Zikula_View::getInstance('EZComments');
        $renderer->clear_cache('ezcomments_mostcommentsblock_ezcomments.tpl');
