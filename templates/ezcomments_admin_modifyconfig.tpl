...
<fieldset>
    ...
    <p class="z-formnote z-informationmsg">{gt text='Notice: <a href="http://akismet.com/">Akismet</a> is a spam detection service that can, in many cases, eliminate comment and trackback spam. To use Akismet you need to install and configure the <a href="https://github.com/zikula-modules/EZComments/">Akismet module</a>.'}</p>
    {if $akismetavailable}
    <div class="z-formrow">
