...
class EZComments_Admin extends Zikula_Controller
{
    /**
    ...
    public function modifyconfig()
    {
        ...
        return $zform->pnFormExecute('ezcomments_admin_modifyconfig.htm', new EZComments_Form_Handler_Admin_ModifyConfig());
    }
